(function() {
  ...
  module.exports = Upgrade = (function(_super) {
    ...
    Upgrade.commandNames = ['upgrade', 'outdated'];
    ...
    Upgrade.prototype.parseOptions = function(argv) {
      ...
      return options.string('compatible').describe('compatible', 'Only list packages/themes compatible with this Atom version');
    };

    Upgrade.prototype.getInstalledPackages = function() {
      var name, pack, packages, _i, _len, _ref;
      packages = [];
    ...
    Upgrade.prototype.loadInstalledAtomVersion = function(options, callback) {
      if (options.argv.compatible) {
        return process.nextTick((function(_this) {
          return function() {
            if (semver.valid(options.argv.compatible)) {
              _this.installedAtomVersion = options.argv.compatible;
            }
            return callback();
          };
        })(this));
      ...
      return request.get(requestSettings, (function(_this) {
        return function(error, response, body) {
          ...
          if (error != null) {
            ...
            if (latestVersion !== pack.version && _this.repositoriesMatch(pack, body)) {
    ...
    Upgrade.prototype.repositoriesMatch = function(packageA, packageB) {
      var repoA, repoB;
    ...
    Upgrade.prototype.installUpdates = function(updates, callback) {
      var installCommands, latestVersion, pack, _fn, _i, _len, _ref;
      installCommands = [];
