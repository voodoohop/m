    ...
    ThemeConverter.prototype.convert = function(callback) {
      return this.readTheme((function(_this) {
        return function(error, themeContents) {
          ...
          fs.writeFileSync(path.join(_this.destinationPath, 'stylesheets', 'base.less'), theme.getStylesheet());
          fs.writeFileSync(path.join(_this.destinationPath, 'stylesheets', 'syntax-variables.less'), theme.getSyntaxVariables());
          return callback();
        };
      })(this));
    };
