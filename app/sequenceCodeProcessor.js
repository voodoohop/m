...
export default function(seq) {
  try {
    ...
    var compiled = traceur.compile(seq.code,{modules:"register", generators:"parse", blockBinding:"parse"});
    return _.extend({
    ...
    return new Bacon.Error({msg:"code process error",exception:exception});
  }
}
