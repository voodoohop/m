...
import {immutableTom, addObjectProp, addObjectProps} from "./proxiedImmutable";
...
var profileSamples = 5000;

for (var n of kick.toPlayable().take(profileSamples))
  profilerDataStore.push({time:n.time, pitch:n.pitch, veloctiy: n.velocity, type:n.type});

for (var n of tom.toPlayable().take(profileSamples))
  profilerDataStore.push({time:n.time, pitch:n.pitch, veloctiy: n.velocity});
...
console.log(profilerDataStore.length);
